 ...
 * description : 单选 图片
 */
public class ImageSingleSelectActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            intent.putExtra(ImagePicker.EXTRA_RESULT_ITEMS, mCurrentPosition);
